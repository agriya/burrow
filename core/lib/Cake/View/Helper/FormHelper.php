...
class FormHelper extends AppHelper
{
    ...
    public function input($fieldName, $options = array())
    {
        ...
        switch ($type) {
            ...
            case 'url':
                $input = $this->text($fieldName, array(
                    'type' => 'url'
                ) +$options);
                break;
        ...
        if (!empty($help)) {
            ...
            } else $out['help'] = $this->Html->tag('span', $help, 'help');
        }
        // <--
    ...
    public function file($fieldName, $options = array())
    {
        ...
        return $this->Html->useTag('file', $options['name'], array_diff_key($options, array(
            'name' => ''
        )));
    }
    /**
    ...
    public function dateTime($fieldName, $dateFormat = 'DMY', $timeFormat = '12', $attributes = array())
    {
        ...
        if (isset($attributes['id'])) {
            if (is_string($attributes['id'])) {
                ...
                foreach($elements as $element) {
                    ...
                    ['id'] = $attributes['id'][strtolower($element) ];
                }
            }
        } else {
        ...
        foreach(preg_split('//', $dateFormat, -1, PREG_SPLIT_NO_EMPTY) as $char) {
            switch ($char) {
                case 'Y':
                    ...
                    $selects[] = $this->year($fieldName, $minYear, $maxYear, $selectYearAttr);
                    break;
        ...
        switch ($timeFormat) {
            case '24':
                ...
                $opt.= $this->hour($fieldName, true, $selectHourAttr) . ':' . $this->minute($fieldName, $selectMinuteAttr);
                break;
            ...
            case '12':
                ...
                $opt.= $this->hour($fieldName, false, $selectHourAttr) . ':' . $this->minute($fieldName, $selectMinuteAttr) . ' ' . $this->meridian($fieldName, $selectMeridianAttr);
                break;
    ...
    protected function _selectOptions($elements = array() , $parents = array() , $showParents = null, $attributes = array())
    {
        ...
        foreach($elements as $name => $title) {
            ...
            if ($name !== null) {
                if ((!$selectedIsArray && !$selectedIsEmpty && (string)$attributes['value'] == (string)$name) || ($selectedIsArray && in_array($name, $attributes['value']))) {
                    if ($attributes['style'] === 'checkbox') {
