...
?>
	<tr class="<?php echo $class . $active_class;?>">
		<td class="dc"><?php echo $this->Form->input('Habit.'.$habit['Habit']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$habit['Habit']['id'], 'label' => "", 'div' => 'top-space', 'class' => ' js-checkbox-list')); ?></td>
