...
div.propertyMapBubble div.bubbleDescription {
...
div.propertyMapBubble div.bubbleLink {
	text-align:right;
}
div.propertyMapBubble div.bubbleLink a {
	color:#EF540A;
}
.info {
	padding:0 0 0 2px;
...
<div class="maptimize_popup maptimize_info_window">
  <div>
    <div id="propertyMapBubbleContainer">
      <div class="propertyMapBubble">
	  <div class="img"><?php
	   echo $this->Html->link($this->Html->showImage('Property', $property['Attachment'][0], array('dimension' => 'medium_thumb', 'alt' => sprintf(__l('[Image: %s]'), $this->Html->cText($property['Property']['title'], false)), 'title' => $this->Html->cText($property['Property']['title'], false))), array('controller' => 'properties', 'action' => 'view', $property['Property']['slug'],  'admin' => false), array('target'=>'_parent','title'=>$this->Html->cText($property['Property']['title'],false),'escape' => false));
					 ?></div>
	  <div class="info">
        <div class="bubbleMerchantName"> <?php echo $this->Html->link($this->Html->cText($property['Property']['title'], false), array('controller' => 'properties', 'action' => 'view', $property['Property']['slug'], 'admin' => false), array('target'=>'_parent','title'=>$this->Html->cText($property['Property']['title'], false),'escape' => false)); ?></div>
