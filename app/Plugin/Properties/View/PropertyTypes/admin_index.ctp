<?php /* SVN: $Id: $ */ ?>
<div class="propertyTypes index js-response">
...
<div class="clearfix">
	<?php 
				...
				echo $this->Html->link( '
					...
					, array('controller'=>'property_types','action'=>'index','filter_id' => ConstMoreAction::Active), array('escape' => false,'class'=>'no-under show pull-left mob-clr bot-space bot-mspace cur'));
				...
				echo $this->Html->link( '
					...
					, array('controller'=>'property_types','action'=>'index','filter_id' => ConstMoreAction::Inactive), array('escape' => false,'class'=>'no-under show pull-left mob-clr bot-space bot-mspace cur'));
				...
				echo $this->Html->link( '
					...
					, array('controller'=>'property_types','action'=>'index'), array('escape' => false,'class'=>'no-under show pull-left mob-clr bot-space bot-mspace cur'));
				
				?>
				</div><div class="clearfix dc">
					<?php echo $this->Form->create('PropertyType', array('method' => 'get', 'class' => 'form-search bot-mspace big-input span', 'action'=>'index')); ?>
					...
					<?php echo $this->Html->link('<span class="ver-smspace"><i class="icon-plus-sign no-pad top-smspace"></i></span>', array('controller' => 'property_types', 'action' => 'add'), array('escape' => false,'class' => 'add btn btn-primary textb text-18 whitec','title'=>__l('Add'))); ?>
				</div>
			</div>
	...
	echo $this->Form->create('PropertyType' , array('class' => 'normal','action' => 'update'));
...
<div class="ver-space">
	...
	<tr class=" well no-mar no-pad">
		<th class="sep-right dc span2 span2"><?php echo __l('Select'); ?></th>
        <th class="sep-right dc span2 span2"><?php echo __l('Actions');?></th>
...
?>
	<tr class="<?php echo $class.' '.$active_class;?>">
		<td class="dc"><?php echo $this->Form->input('PropertyType.'.$propertyType['PropertyType']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$propertyType['PropertyType']['id'], 'label' => "", 'div' => 'top-space', 'class' => $status_class.' js-checkbox-list')); ?></td>
		<td class="dc"><span class="dropdown"> <span title="Actions" data-toggle="dropdown" class="graydarkc left-space hor-smspace icon-cog text-18 cur dropdown-toggle"> <span class="hide">Action</span> </span>
					...
					<li><?php echo $this->Html->link('<i class="icon-edit"></i>'.__l('Edit'), array('action' => 'edit', $propertyType['PropertyType']['id']), array('escape' => false,'class' => 'delete', 'title' => __l('Edit')));?></li>
        			<li><?php echo $this->Html->link('<i class="icon-remove"></i>'.__l('Delete'), array('action' => 'delete', $propertyType['PropertyType']['id']), array('escape' => false,'class' => 'delete js-delete', 'title' => __l('Delete')));?></li>
			   </ul>
							 </span>
                            </td>
		<td class="dc"><?php echo $this->Html->cDateTime($propertyType['PropertyType']['created']);?></td>
		<td class="dl"><?php echo $this->Html->cText($propertyType['PropertyType']['name']);?></td>
	</tr>
<?php
    endforeach;
else:
?>
	<tr>
		<td colspan="7"><div class="space dc grayc"><p class="ver-mspace top-space text-16 "><?php echo __l('No Property Types available');?></p></div></td>
	</tr>
<?php
endif;
?></tbody>
