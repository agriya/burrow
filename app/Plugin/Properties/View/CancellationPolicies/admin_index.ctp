...
<ul class="breadcrumb top-mspace ver-space">
	...
	<?php 
				...
				echo $this->Html->link( '
					...
					, array('controller'=>'cancellation_policies','action'=>'index','filter_id' => ConstMoreAction::Active), array('escape' => false,'class'=>'no-under show pull-left mob-clr bot-space bot-mspace cur'));
				...
				echo $this->Html->link( '
					...
					, array('controller'=>'cancellation_policies','action'=>'index','filter_id' => ConstMoreAction::Inactive), array('escape' => false,'class'=>'no-under show pull-left mob-clr bot-space bot-mspace cur'));
				...
				echo $this->Html->link( '
					...
					, array('controller'=>'cancellation_policies','action'=>'index'), array('escape' => false,'class'=>'no-under show pull-left mob-clr bot-space bot-mspace cur'));
				...
				?>
					...
					<?php echo $this->Html->link('<span class="ver-smspace"><i class="icon-plus-sign no-pad top-smspace"></i></span>', array('controller' => 'cancellation_policies', 'action' => 'add'), array('escape' => false,'class' => 'add btn btn-primary textb text-18 whitec','title'=>__l('Add'))); ?>
				</div>
...
<div class="ver-space">
	...
	<tr class=" well no-mar no-pad">
	    ...
	    <th class="sep-right dc"><?php echo $this->Paginator->sort( 'days',__l('Prior Days'));?></th>
	    <th class="sep-right dc"><?php echo $this->Paginator->sort( 'percentage',__l('Percentage'));?></th>
	    <th class="sep-right dc"><?php echo $this->Paginator->sort( 'property_count',__l('Properties Count'));?></th>
    </tr></thead><tbody>
<?php
...
?>
	<tr class="<?php echo $class.' '.$active_class;?>">
		<td class="dc"><?php echo $this->Form->input('CancellationPolicy.'.$cancellationPolicy['CancellationPolicy']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$cancellationPolicy['CancellationPolicy']['id'], 'label' => "", 'div' => 'top-space', 'class' => $status_class.' js-checkbox-list')); ?></td>
		 <td class="dc"><span class="dropdown"> <span title="Actions" data-toggle="dropdown" class="graydarkc left-space hor-smspace icon-cog text-18 cur dropdown-toggle"> <span class="hide">Action</span> </span>
					...
					<li><?php echo $this->Html->link('<i class="icon-edit"></i>'.__l('Edit'), array('action' => 'edit', $cancellationPolicy['CancellationPolicy']['id']), array('escape' => false,'class' => 'delete', 'title' => __l('Edit')));?></li>
        			<li><?php echo $this->Html->link('<i class="icon-remove"></i>'.__l('Delete'), array('action' => 'delete', $cancellationPolicy['CancellationPolicy']['id']), array('escape' => false,'class' => 'delete js-delete', 'title' => __l('Delete')));?></li>
			   </ul>
							 </span>
                            </td>
...
?>
	<tr>
		<td colspan="8"><div class="space dc grayc"><p class="ver-mspace top-space text-16 "><?php echo __l('No Cancellation Policies available');?></p></div></td>
	</tr>
<?php
endif;
?></tbody>
