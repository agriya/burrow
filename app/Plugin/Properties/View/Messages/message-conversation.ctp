...
<div class="ver-space">
  <h3 class="ver-space textb"><?php echo __l('Activities');?></h3>
	...
	<?php if($this->request->params['named']['admin_view']) {
		$class = "row-fluid";
		$date_class = "span2";
		$activity_content = "span21";
	} else {
		$class = "";
		$date_class = "span3";
		$activity_content = "span18";
	} ?>
<div class="well bot-mspace <?php echo $class;?>">
	...
	?>
		<?php if(!empty($message['Message']['property_user_status_id'])):?>
			...
			<li class="bot-space <?php echo $user_type_container_class;?>">
				...
				<span data-toggle="popover" data-placement="right" class="date-info blackc textb <?php echo $date_class;?> ">
					<?php echo $this->Time->timeAgoInWords($message['Message']['created']);?>
				</span>
                <div class="thumbnail no-round activity-content <?php echo $activity_content;?> mob-ps pr pull-right">
					<span class="dispute-status dc span2 tab-clr hor-mspace text-11 textb bot-space">
					...
					<p class="<?php echo $span_size;?>  span16-sm clearfix no-mar"> <?php echo $this->Html->cText($message['MessageContent']['subject']);?> </p>
                </div>
              </div>	
			</li>
			<?php endif;?>
			...
			<li class="bot-space <?php echo $user_type_container_class;?>">
				<div class="row no-mar"> 
					...
					<div class="thumbnail no-round activity-content <?php echo $activity_content;?> mob-ps pr pull-right">
						...
						<div class="<?php echo $span_size;?>   span16-sm clearfix no-mar"> 
			...
			<?php if(!empty($message['Message']['property_user_status_id']) && ($message['Message']['property_user_status_id'] == ConstPropertyUserStatus::WorkDelivered || $message['Message']['property_user_status_id'] == ConstPropertyUserStatus::WorkReviewed) && $message['Message']['property_user_status_id'] != ConstPropertyUserStatus::NegotiateConversation && $message['Message']['property_user_status_id'] != ConstPropertyUserStatus::PrivateConversation && $message['Message']['property_user_status_id'] != ConstPropertyUserStatus::FromTravelerConversation && $message['Message']['property_user_status_id'] != ConstPropertyUserStatus::RequestNegotiation && $message['Message']['property_user_status_id'] != ConstPropertyUserStatus::SecurityDepositRefund):?>
				...
				<li class="bot-space <?php echo $user_type_container_class;?>">	
					<div class="row no-mar"> 
						...
						<div class="thumbnail no-round activity-content offset1 space <?php echo $activity_content;?> mob-ps pr pull-right">
							<span class="expired-status dc span2 tab-clr hor-mspace text-11 textb bot-space">
						...
						<div class="<?php echo $avatar_positioning_class;?>">	
							...
							<div class="avatar-info-block">
								<blockquote class="no-bor no-pad">
							...
							if(!empty($message['PropertyUser'][$key])):?>
								<li class="bot-space <?php echo $user_type_container_class;?>">
								  <div class="row no-mar"> 
									...
									<div class="thumbnail no-round activity-content <?php echo $activity_content;?> mob-ps pr pull-right">
										<span class="arrive-status dc span2 tab-clr hor-mspace text-11 textb bot-space">		<?php
		...
		<?php if($message['Message']['property_user_status_id'] == ConstPropertyUserStatus::PrivateConversation && $message['Message']['user_id'] == $this->Auth->user('id')):?>				
				...
				<li class="bot-space <?php echo $user_type_container_class;?>">
				  <div class="row no-mar"> 
					...
					<div class="thumbnail no-round activity-content offset1 <?php echo $activity_content;?> mob-ps pr pull-right">
