...
/*else {
            ...
            for (var i = 0; i <= index; i ++ ) {
                ...
                for (var j = 0; j < ec; j ++ ) {
                    ...
                    if (e) {
                        ...
                        price_detail = '';
                        if (e[11] == 'available') {
                            title = e[14] + ' ' + e[15] + '(' + currency_symbol + e[13] + ')';
                            price_detail = currency_symbol + e[13];
                        } else {
                            title = e[14] + ' ' + e[15] + '(' + e[11] + ')';
                            price_detail = e[11];
                        }
        ...
        function weekshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    ...
                    temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/></div></div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" value="');
                    ...
                    temparr.push('<div id="bbit-cal-quickNegotiateBTN" class="cancel-block"><a href="' + __cfg('path_absolute') + 'activity/' + data[0] + '" class="js-negotiate btn btn-primary text-14 textb dc offset3">Negotiate</a></div>');
        ...
        function monthshow(e, data) {
            ...
            if (monthly.length > 0) {
                ...
                temparr.push('<td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root">');
                temparr.push('<table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr ><th class="cb-key">');
                temparr.push(i18n.xgcalendar.title, ':</th><td class="cb-value"><div class="textbox-fill-title" id="js-property-list"> </div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.time, ':</th><td class="cb-value"><div id="bbit-cal-buddle-timeshow"></div></td></tr><tr class="js-price"><th class="cb-key">');
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/></div></div></td></tr>');

                temparr.push('</tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="js-propertiypermonth-id" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" value="');
                temparr.push(i18n.xgcalendar.update_detail, '" class="btn btn-primary text-14 textb dc offset3" type="button"/>');
                temparr.push('</div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class="bubble-sprite"></div></div></div>');
                var tempquickAddHanler = temparr.join("");
                temparr = null;
                ...
                html = '';
                //Available and not available cases
                html += '<select  id="js-property_list_select">';
                ...
                html += '</select>';
                $("#js-property-list").html(html);
                select_property = $('#js-property_list_select').val();
                start_date = end_date = '';
                available = 1;
                var price;
                $.each(monthly, function(index, value) {
                    if (value[0] == select_property) {
                        start_date = parseDate(value[3]);
                        end_date = parseDate(value[4]);
                        price = parseFloat(value[5]);
                        $("#bbit-cal-start").val(value[3]);
                        $("#bbit-cal-end").val(value[4]);
                        $('#js-propertiypermonth-id').val(value[2]);
                    }
                });
                var ss = [];
                ...
                var ts = $("#bbit-cal-buddle-timeshow").html(ss.join(""));
                $('#bbit-cal-what').val(price);

                $("#js-property_list_select").change(function(e) {
                    select_property = $(this).val();
                    $.each(monthly, function(index, value) {
                        if (value[0] == select_property) {
                            $('#bbit-cal-what').val(parseFloat(value[5]));
                            $("#bbit-cal-start").val(value[3]);
                            $("#bbit-cal-end").val(value[4]);
                            $('#js-propertiypermonth-id').val(value[2]);
                        }
                ...
                $("#bbit-cal-quickAddBTN").click(function(e) {
                    ...
                    var datestart = $("#bbit-cal-start").val();
                    var dateend = $("#bbit-cal-end").val();
                    var property_id = $('#js-property_list_select').val();
                    var price = price;
                    var desc = '';
                    var model = 'CustomPricePerMonth';
                    var color = '';
                    var primary_id = $('#js-propertiypermonth-id').val();
                    //var status=$('.js-select').val();
                    var zone = new Date().getTimezoneOffset() / 60 * -1;
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    ...
                    temparr.push(i18n.xgcalendar.time, ':</th><td class="cb-value"><div class="demo"><label for="from">From</label><input type="text" id="from" name="from" readonly="readonly"/><div class="datepicker-content js-datewrapper ui-corner-all" style="display:none;"><div id="fromdatediv"></div><span class=""><a href="javascript:void(0);" id="fromclose" class="close" style="visibility:hidden">Close</a></span></div><br/><label for="to">To</label><input type="text" id="to" name="to" readonly="readonly"/><div class="datepicker-content datepicker-content1 js-datewrapper1 ui-corner-all" style="display:none;"><div id="todatediv"></div><span id="js-toclose"><a href="javascript:void(0);" id="toclose" class="close" style="visibility:hidden">Close</a></span></div></div></td></tr>');

                    //Available and not available cases
                    //if(data[9]==99 || data[9]==0)
                    //{
                    // price
                    temparr.push('<tr class="js-price"><th class="cb-key">');
                    temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/><div id="error-message" style="display:none;">Must be greater than zero </div></div></div></td></tr>');
                    //}
                    // status
                    ...
                    if (bud.length == 0) {
                        bud = $(tempquickAddHanler).appendTo(document.body);
                        $("#from").val(dateFormat.call(data[2], i18n.xgcalendar.dateformat.Md3) + ', ' + data[2].getFullYear());
                        $("#to").val(dateFormat.call(data[3], i18n.xgcalendar.dateformat.Md3) + ', ' + data[3].getFullYear());
                        $('#bbit-cal-quickConfirmBTN').hide();
                        $('#bbit-cal-quickRejectBTN').hide();
                        $('#bbit-cal-quickNegotiateBTN').hide();
                        var calbutton = $("#bbit-cs-delete");
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push('<table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.title, ':</th><td class="cb-value"><div class="textbox-fill-title js-propertity-list"></div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.time, ':</th><td class="cb-value"><div class="demo"><label for="from">From</label><input type="text" id="from" name="from" readonly="readonly"/><div class="datepicker-content js-datewrapper ui-corner-all" style="display:none;"><div id="fromdatediv"></div><span class=""><a href="javascript:void(0);" id="fromclose" class="close" style="visibility:hidden">Close</a></span></div><br/><label for="to">To</label><input type="text" id="to" name="to" readonly="readonly"/><div class="datepicker-content datepicker-content1 js-datewrapper1 ui-corner-all" style="display:none;"><div id="todatediv"></div><span id="js-toclose"><a href="javascript:void(0);" id="toclose" class="close" style="visibility:hidden">Close</a></span></div></div></td></tr><tr class="js-price"><th class="cb-key">');
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/><div id="error-message" style="display:none;">Must be greater than zero </div></div></div><div class="cb-example">');
...
/*var f = /^[^\$\<\>]+$/.test(what);
                        ...
                        $.post(option.quickAddUrl, param, function(data) {
                            if (data) {
                                if (data.IsSuccess == true) {
                                    ...
                                    option.isloading = false;
                                    option.onAfterRequestData && option.onAfterRequestData(2);
                                    $("#errorpannel").removeClass('loaderror').addClass('loadicon').html('Custom price could not be added for this date.');
                                }
            ...
            html += '</select>';
            $(".js-propertity-list").html(html);
            if (property_list[0]) {
                $('#js-property_list_select').val(property_list[0]['id']);
                $("#bbit-cal-what").val(property_list[0]['price']);
            }
            // property select box end
            $("#js-property_list_select").change(function(e) {
                select_property = $(this).val();
                $.each(property_list, function(index, value) {
                    if (value['id'] == select_property) {
                        $('#bbit-cal-what').val(parseFloat(value['price']));
                        $('#js-property_list_select').val(value['id']);
                    }
                });
            });
